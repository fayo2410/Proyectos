...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //AQUI UBICAMOS EL FRAGMENT QUE QUEREMOS QUE APRAREZCA AL PRINCIPIO...
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_agregar) {
            fragmentManager.beginTransaction().replace(R.id.contenedor, new Agregar()).commit();
        } else if (id == R.id.nav_eliminar) {
            fragmentManager.beginTransaction().replace(R.id.contenedor, new Eliminar()).commit();
