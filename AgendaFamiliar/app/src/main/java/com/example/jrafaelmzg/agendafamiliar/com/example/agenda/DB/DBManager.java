...
public class DBManager {
    ...
    public long insertarFamiliar(Familiar f){
        ...
        return familiarDB.insert(f.nombreCompleto,f.parentesco, f.correoElectronico, f.numeroCelular);
    }
    ...
    public boolean updateFamiliar(Familiar newFamiliar){
        familiarDB = new FamiliarDB(db);
        return familiarDB.update(newFamiliar._id, newFamiliar.nombreCompleto, newFamiliar.parentesco,
                newFamiliar.numeroCelular, newFamiliar.correoElectronico);
    }
}
